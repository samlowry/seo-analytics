...
A('\n**Критерий осмысленного запроса:** в нём есть бренд (Mostbet) или контекст БК/букмекер/ставки. Вопросы без того и другого '
  '(«задержка Kaspi», «как проходит верификация») Google читает как доставку Kaspi и общий KYC — они из прогона исключены.\n'
